...
from lab6.src.book_manager import BookManager
...
class TestBookManager(unittest.TestCase):
    ...
    def test_remove_book(self):
        ...
        self.manager.add_book("B003", "Java Programming", "John Smith")
        self.manager.register_user("U001", "Alice Brown")
        self.manager.borrow_book("B003", "U001")

        # Test removing a non-existent book
        result = self.manager.remove_book("B002")
        self.assertFalse(result)

        self.assertFalse(self.manager.remove_book("B003"))
        self.assertIn("B003", self.manager.books)
    ...
    def test_return_book(self):
        ...
        self.manager.add_book("B001", "Python Programming", "John Smith")
        self.manager.add_book("B003", "Python Programming", "John Smith")
        self.manager.register_user("U001", "Alice Brown")
        ...
        result = self.manager.return_book("B003", "U001")
        self.assertFalse(result)
    ...
    def test_search_books(self):
        ...
        results = self.manager.search_books(None)
        self.assertEqual(len(results), 0)
