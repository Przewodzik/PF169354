...
class TestBank(unittest.TestCase):
    ...
    def test_fetch_currencies_success(self, mock_get):
        ...
        mock_get.assert_called_once_with('https://api.nbp.pl/api/exchangerates/tables/A/?format=json')
    ...
    def test_add_new_transaction(self):
        ...
        result = self.bank.add_new_transaction(transaction=transaction, account_number=account_number)
        ...
        self.bank.add_new_transaction(transaction=transaction2, account_number=account_number)
    ...
    def test_get_transactions(self):
        ...
        self.bank.add_new_transaction(transaction=transaction1, account_number=account_number)
        self.bank.add_new_transaction(transaction=transaction2, account_number=account_number)
    ...
    def test_get_transactions_by_date(self):
        ...
        self.bank.add_new_transaction(transaction=transaction1, account_number=account_number)
        self.bank.add_new_transaction(transaction=transaction2, account_number=account_number)
        self.bank.add_new_transaction(transaction=transaction3, account_number=account_number)
    ...
    def test_get_transactions_by_date_empty_result(self):
        ...
        self.bank.add_new_transaction(transaction=transaction, account_number=account_number)
