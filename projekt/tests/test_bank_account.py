...
class TestBankAccount(unittest.TestCase):
    ...
    def test_initialization_failure(self):
        ...
        with self.assertRaises(TypeError):
            BankAccount(owner="not a user", bank=self.bank, pin_code='123456', balance=1000)

        with self.assertRaises(TypeError):
            BankAccount(owner=self.user, bank="not a bank", pin_code='123456', balance=1000)

        with self.assertRaises(TypeError):
            BankAccount(owner=self.user, bank=self.bank, pin_code='123456', balance="not a number")

        with self.assertRaises(ValueError):
            BankAccount(owner=self.user, bank=self.bank, pin_code='123456', balance=-100)

        with self.assertRaises(TypeError):
            BankAccount(owner=self.user, bank=self.bank, pin_code='123456', balance=1000, currency=123)

        with self.assertRaises(ValueError):
            BankAccount(owner=self.user, bank=self.bank, pin_code='123456', balance=1000, currency='XYZ')
    ...
    def test_generate_account_number(self):
        ...
        bank_account2 = BankAccount(owner=self.user2, bank=self.bank2, pin_code='123456')
        bank_account3 = BankAccount(owner=self.user3, bank=self.bank, pin_code='123456')
        bank_account4 = BankAccount(owner=self.user3, bank=self.bank2, pin_code='123456')
    ...
    def test_close_bank_account_success(self):
        ...
        self.assertEqual(self.bank.accounts[self.account.account_number].status, AccountStatus.CLOSED)
    ...
    def test_withdraw_success(self):
        ...
        transactions = self.bank.get_transactions(account_number=self.account.account_number)
    ...
    def test_transfer_success_same_currency(self):
        ...
        bank_account = BankAccount(owner=self.user2, bank=self.bank, pin_code='123456',balance=200)

        self.account.transfer(amount=500,to_account_number=bank_account.account_number,pin_code='123456',bank=bank_account.bank)
        ...
        transactions = self.bank.get_transactions(account_number=bank_account.account_number)
        self.assertEqual(len(transactions), 1)
    ...
    def test_transfer_success_different_currency(self):
        ...
        bank_account = BankAccount(owner=self.user2, bank=self.bank, pin_code='123456', balance=200,currency='USD')
    ...
    def test_transfer_invalid_amount(self):
        ...
        with self.assertRaises(ValueError):
            self.account.transfer(amount=-100,pin_code='123456',to_account_number=bank_account.account_number,bank=bank_account.bank)
        with self.assertRaises(ValueError):
            self.account.transfer(amount=0,pin_code='123456',to_account_number=bank_account.account_number,bank=bank_account.bank)
    ...
    def test_transfer_invalid_type_amount(self):
        ...
        for invalid_type in invalid_types:
            with self.subTest(amount=invalid_type):
                with self.assertRaises(TypeError):
                    self.account.transfer(amount=invalid_type, pin_code='123456',to_account_number=bank_account.account_number,bank=bank_account.bank)
    ...
    def test_transfer_amount_greater_than_balance(self):
        ...
        with self.assertRaises(ValueError):
            self.account.transfer(amount=1100,to_account_number=bank_account.account_number,pin_code='123456',bank=bank_account.bank)
    ...
    def test_transfer_to_not_active_account(self):
        ...
        with self.assertRaises(ValueError):
            self.account.transfer(amount=900,to_account_number=bank_account.account_number, pin_code='123456',bank=bank_account.bank)
    ...
    def test_transfer_non_existing_to_account(self):
        ...
        with self.assertRaises(ValueError):
            self.account.transfer(amount=100,to_account_number='987654321',pin_code='123456',bank=self.bank)
    ...
    def test_change_currency_invalid_type(self):
        ...
        for invalid_type in invalid_types:
            with self.subTest(currency=invalid_type):
                with self.assertRaises(TypeError):
                    self.account.change_currency(currency = invalid_type, pin_code='123456')
